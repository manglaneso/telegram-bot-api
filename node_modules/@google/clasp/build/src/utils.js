...
export const getErrorMessage = (value) => {
    ...
    else if ((value === null || value === void 0 ? void 0 : value.statusCode) === 401 || ((value === null || value === void 0 ? void 0 : value.error) && value.error.error && value.error.error.code === 401)) {
...
export const getWebApplicationURL = (value) => {
    ...
    throw new ClaspError(ERROR.NO_WEBAPP((_a = value.deploymentId) !== null && _a !== void 0 ? _a : ''));
};
/**
 * Gets default project name.
 * @return {string} default project name.
 */
export const getDefaultProjectName = () => capitalize(path.basename(process.cwd()));
/**
